Ниже представлен **новый README.md** для вашего проекта `aproject` (Crypto Sentinel). Он охватывает все добавленные функции и даёт чёткие инструкции по запуску и использованию.
